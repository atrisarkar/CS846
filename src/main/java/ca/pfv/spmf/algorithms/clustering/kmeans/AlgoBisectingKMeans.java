...
public class AlgoBisectingKMeans extends AlgoKMeans{
	 ...
	 */
	public List<Cluster> runAlgorithm(String inputFile, int k, 
	...
	void applyAlgorithm(int k, DistanceFunction distanceFunction,
		...
		while(true) {
			...
			List<Cluster> bestClustersUntilNow = null;
			...
			for(int i = 0; i < iter; i++) {
				List<Cluster> newClusters = applyKMeans(2, distanceFunction, currentVectors, minValue, maxValue, vectorsSize);
