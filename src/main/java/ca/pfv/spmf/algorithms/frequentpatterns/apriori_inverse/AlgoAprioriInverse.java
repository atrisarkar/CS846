...
public class AlgoAprioriInverse {
	...
	public Itemsets runAlgorithm(double minsup, double maxsup, String input, String output) throws IOException {
		return runAlgorithm( minsup,  maxsup,  input,  output, true);
	}
	 ...
	 */
	public Itemsets runAlgorithm(double minsup, double maxsup, String input, String output, boolean isFile) throws IOException {
