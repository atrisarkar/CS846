...
public class AlgoFPGrowth {
	...
	public Itemsets runAlgorithm(String input, String output, double minsupp) throws FileNotFoundException, IOException {
		return runAlgorithm(input, output, minsupp, true);
	}
	 ...
	 */
	public Itemsets runAlgorithm(String input, String output, double minsupp, boolean isFile) throws FileNotFoundException, IOException {
		// record start time
		...
		final Map<Integer, Integer> mapSupport = scanDatabaseToDetermineFrequencyOfSingleItems(input,isFile); 
...
//			Set<Integer> alreadySeen = new HashSet<Integer>();
	 ...
	 */
	private  Map<Integer, Integer> scanDatabaseToDetermineFrequencyOfSingleItems(String input,boolean isFile)
